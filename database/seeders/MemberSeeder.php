...
",
        ...
        [
            ...
            "horoskop"=> "Aquarius",
            "tinggi_badan"=> "154",
            "nama_panggilan"=> "Carissa",
            "role"=> "trainee",
            "foto"=> "carissa_dini.jpg",
            "twitter" => "",
            "instagram" => "",
        ],
        [
            ...
            "horoskop"=> "Pisces",
            "tinggi_badan"=> "161",
            "nama_panggilan"=> "Bella",
            "role"=> "trainee",
            "foto"=> "christabella_bonita.jpg",
            "twitter" => "",
            "instagram" => "",
        ],
        [
            ...
            "horoskop"=> "Leo",
            "tinggi_badan"=> "152",
            "nama_panggilan"=> "Fahira",
            "role"=> "trainee",
            "foto"=> "fahira_putri.jpg",
            "twitter" => "",
            "instagram" => "",
        ],
        [
        ...
        [
            ...
            "horoskop"=> "Virgo",
            "tinggi_badan"=> "164",
            "nama_panggilan"=> "Heidi",
            "role"=> "trainee",
            "foto"=> "heidi_suyangga.jpg",
            "twitter" => "",
            "instagram" => "",
        ],
        [
            "name"=> "Maxine Faye",
            "tanggal_lahir"=> "2011-12-02",
            "golongan_darah"=> "B",
            "horoskop"=> "Sagitarius",
            "tinggi_badan"=> "164",
        ...
        [
            ...
            "horoskop"=> "Pisces",
            "tinggi_badan"=> "159",
            "nama_panggilan"=> "Jazzy",
            "role"=> "trainee",
            "foto"=> "putry_jazyta.jpg",
            "twitter" => "",
            "instagram" => "",
        ],
        [
            "name"=> "Ralyne Van Irwan",
            "tanggal_lahir"=> "2011-10-15",
            "golongan_darah"=> "AB",
            "horoskop"=> "Libra",
            "tinggi_badan"=> "152",
            "nama_panggilan"=> "Ralyne",
            "role"=> "trainee",
            "foto"=> "ralyne_van_irwan.jpg",
            "twitter" => "",
            "instagram" => "",
        ],
        [
